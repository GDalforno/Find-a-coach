  ...
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !areas.isValid}">
      ...
      <div>
        ...
        <label for="frontent">Career Advisory</label>
      </div>
      <p v-if="!areas.isValid">At least expertise must be selected.</p>
    </div>
    <p v-if="!formIsValid">Please fix the above errors and sumit again.</p>
